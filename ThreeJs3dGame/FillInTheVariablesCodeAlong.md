...
There are a ton of different variables to tweak. See what happens when you mess with them! As you go, keep in mind that _some_ parts of the code need to stay the same for the program to actually work. Here are some of the important things you should not touch:
