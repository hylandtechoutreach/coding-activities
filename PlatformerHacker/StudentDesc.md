...
### More on Variables
In computer science, **variables** are containers for information that can _change_. Variables have a name (e.g., `SPEED`, `backgroundColor`, `age`) and a value (e.g., `1200`, `"orange"`, `11`). Changing the _value_ of a variable will change how the game is played! However, it is important not to change the _name_ of the variable (e.g., `JUMP_SPEED` should stay the same), or the equals sign (`=`).
